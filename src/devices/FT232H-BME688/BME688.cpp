...
float BME688::getTemperature() {
  uint32_t temp_adc = (uint32_t)tempuratureBytes[0] << 12 |
                      (uint32_t)tempuratureBytes[1] << 4 |
                      (uint32_t)tempuratureBytes[2] >> 4;
...
float BME688::getPressure() {
  uint32_t press_adc = ((int32_t)pressureBytes[0]) << 12 |
                       (int32_t)pressureBytes[1] << 4 |
                       (int32_t)pressureBytes[2] >> 4;
  ...
  var1 =
      ((((var1 / 4) * (var1 / 4)) / 8192) * (pressCalibData.parP3 * 32) / 8) +
  ...
  var1 = (pressCalibData.parP9 * (((calc_pres / 8) * (calc_pres / 8)) / 8192)) /
         4096;
  var2 = ((calc_pres / 4) * pressCalibData.parP8) / 8192;
  int32_t var3 = (((calc_pres / 256) * (calc_pres / 256) * (calc_pres / 256)) *
                  pressCalibData.parP10) /
                 131072;
...
float BME688::getHumidity() {
  ...
  int32_t var1 =
      (int32_t)(hum_adc - ((int32_t)((int32_t)humCalibData.parH1 * 16))) -
  ...
  int32_t var2 =
      ((int32_t)humCalibData.parH2 *
       (((scaledTemp * (int32_t)humCalibData.parH4) / ((int32_t)100)) +
        (((scaledTemp *
           ((scaledTemp * (int32_t)humCalibData.parH5) / ((int32_t)100))) >>
          6) /
         ((int32_t)100)) +
        (int32_t)(1 << 14))) >>
      10;
  ...
  var4 = ((var4) +
          ((scaledTemp * (int32_t)humCalibData.parH7) / ((int32_t)100))) >>
         4;
